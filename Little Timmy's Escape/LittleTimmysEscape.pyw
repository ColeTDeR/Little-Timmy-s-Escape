...
class Game:
    def __init__(self):
        self.tk = Tk()
        self.tk.title('Little Timmy\'s Escape')
            ...
            for y in range(0, 5):
                ...
                if count == 6:
                    self.canvas.create_image(x * w, y * h,
                                             image=self.bg_bird1, anchor='nw')
                elif count == 17:
                    self.canvas.create_image(x * w, y * h,
                                             image=self.bg_bird2, anchor='nw')
                else:
    ...
    def mainloop(self):
        while 1:
            if self.running:
                ...
                self.canvas.tag_raise(self.game_over_text)
...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        ...
        game.canvas.bind_all('<KeyPress-w>', self.jump)
        game.canvas.bind_all('<Shift_L>', self.stop_moving)
    ...
    def animate(self):
        ...
        if self.x < 0:
            ...
            if self.y != 0:
                ...
                self.game.canvas.itemconfig(self.image,
                                            image=self.
                                            images_right[self.current_image])
